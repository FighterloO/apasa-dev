            ...
            <div class="row">     
                    ...
                    <div class="card card-bordered">
                            <div class="card-header">
                             ...
                             <div class="card-body">
                                ...
                                Nama Pengurus Persediaan : <p style="color: blue;"><?php echo $tampil['penguruscart']; ?></p><br>
                 ...
                 <div class="col-lg-8 col-md-6 mt-5">
                    <div class="card card-bordered">
                        ...
                        <div class="card-body"> 
                            <form method="post" action="page/persetujuan/prosespersetujuan.php">                          
                            <div class="table-responsive data-tables datatable-dark" >
                                ...
                                <td style="text-align: center;">                                   
                                    <input 
                                    <?php 
                                    if ( $tampil['actioncart'] != "diterima") {
                                        echo "disabled";
                                    }

                                     ?>
                                     class="form-control" type="number" min="0" name="stockout[<?php echo $i; ?>]" value="<?php echo $querystockbarang[$i]; ?>">
                                     <!-- hidden input -->
                                    ...
                                    <input class="form-control" type="hidden" name="namapegout[<?php echo $i; ?>]" value="<?php echo $tampil['pegawaipengajuan']; ?>">
                                    <input class="form-control" type="hidden" name="seksiout[<?php echo $i; ?>]" value="<?php echo $tampil['keperluan']; ?>">
                            ...
                            <div align="center">
                                ...
                                <a href="?page=tolakpersetujuanbarang&id=<?php echo $tampil['idcart']; ?>" class="btn btn-danger" onclick="return confirm('konfirmasi penolakan');"><i class="ti-close"></i></a> &emsp;
                                <a href="?page=persetujuanbarang" class="btn btn-warning"><i class=" ti-back-left"></i></a>
                            </div>
                            </form>
                        </div>
                    </div>
