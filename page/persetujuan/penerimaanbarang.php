...
<div class="col-md-12">
    <div class="card">
        ...
        <div class="card-body">
            <p><h1 align="center" class="font-weight-bold text-dark">TABEL PENERIMAAN PENGAJUAN</h1></p>
        </div>
    </div>
        <div class="card">
            <div class="card-body">
                        ...
                        <table id="myTable" class="table table-striped table-bordered table-hover" >
                            ...
                            <tbody>
                                ...
                                function formatTanggal($date){
                                  ...
                                  $no =1;
                                  $sql = $conn->query("select * from pengajuancart where actioncart='ajukan' order by tanggalajucart desc");
                              ...
                              <tr>
                                ...
                                <td align="center"> 
                                    ...
                                    if ($tabelanjay == "ajukan") {
                                    ?>
                                  <a href="?page=infopenerimaanbarang&id=<?php echo $data['idcart']; ?>" class="btn btn-primary" ><i class="ti-info"></i></a>
                                   <?php 
                                  } else{
